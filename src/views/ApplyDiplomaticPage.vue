...
async function submitForm() {
  ...
  try {
    ...
    const { error } = await supabase.from('diplomatic_applications').insert([{
      mission_name: form.value.missionName || 'Not provided',
      country: form.value.country || 'Not provided',
      mission_type: form.value.missionType || 'Not provided',
      mission_address: form.value.address || 'Not provided',
      city: 'Not provided',
      staff_count: 'Not provided',
      rep_title: form.value.title || 'Not provided',
      rep_name: form.value.fullName || 'Not provided',
      rep_email: form.value.email || 'Not provided',
      rep_phone: form.value.phone || 'Not provided',
